...
* from Biblioteca.idl
* lunes 18 de marzo de 2024 20H44' CET
*/
// Define la interfaz para el sistema de gestión de la biblioteca
@SuppressWarnings("hiding")
public class GestionBibliotecaStub<Libro> extends org.omg.CORBA.portable.ObjectImpl implements GestionBiblioteca
{
  ...
  public int numeroLibros() {
    org.omg.CORBA.portable.InputStream $in = null;
    try {
        org.omg.CORBA.portable.OutputStream $out = _request ("numeroLibros", true);
        $in = _invoke ($out);
